...
public class Cdata1204Telnet extends CommutatorCredentials implements OltTelnetCollector {

    private final TelnetParser telnetParser = new TelnetParser();

    public Cdata1204Telnet(String ip, String login, String password) {
        super(ip, login, password);
    }

    public Cdata1204Telnet(String ip) {
        super(ip);
    }
