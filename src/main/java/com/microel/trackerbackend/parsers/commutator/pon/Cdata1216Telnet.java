...
public class Cdata1216Telnet extends CommutatorCredentials implements OltTelnetCollector {

    private final TelnetParser telnetParser = new TelnetParser();

    public Cdata1216Telnet(String ip, String login, String password) {
        super(ip, login, password);
    }

    public Cdata1216Telnet(String ip) {
        super(ip);
    }
