...
public class TaskMapper {
    ...
    public static TaskDto toDto(@Nullable Task task) {
        ...
        return TaskDto.builder()
                ...
                .lastComments(task.getLastComments().stream().map(CommentMapper::toDto).collect(Collectors.toList()))
    ...
    public static Task fromDto(@Nullable TaskDto task) {
        ...
        Task build = Task.builder()
                ...
                .lastComments(task.getLastComments().stream().map(CommentMapper::fromDto).collect(Collectors.toList()))
                .parent(task.getParent())
